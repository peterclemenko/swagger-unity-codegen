...
type AuthorizationStringLocation string
...
type basicAuth struct {
	...
	loc AuthorizationStringLocation
}

// NewAPIKey creates a new API key
func NewAPIKey(identifier string, key string, location AuthorizationStringLocation) APIKeyAuth {
	return APIKeyAuth{
